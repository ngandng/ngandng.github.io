...
**Navigation Variable-based Multi-objective Particle Swarm Optimization for UAV Path Planning with Kinematic Constraints**  
   *Published in Neural Computing and Applications, 2025*  
   [📄 Download Paper](https://doi.org/10.1007/s00521-024-10945-1)
...
**Ant Colony Optimization for Cooperative Inspection Path Planning Using Multiple Unmanned Aerial Vehicles**  
   *Published in 2024 IEEE/SICE International Symposium on System Integration (SII), 2024*  
   [📄 Download Paper](https://doi.org/10.1109/SII58957.2024.10417512)

**Deployment of UAVs for Optimal Multihop Ad-hoc Networks Using Particle Swarm Optimization and Behavior-based Control**  
   *Published in 2022 11th International Conference on Control, Automation and Information Sciences (ICCAIS), 2022*  
   [📄 Download Paper](https://doi.org/10.1109/ICCAIS56082.2022.9990164)
